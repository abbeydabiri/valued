...
func (this *Scheme) GetName() string {
	return "scheme"
}

func (this *Scheme) GetWorkflows() []string {
	return this.Workflows()
}

func (this *Scheme) GetFields() map[string]interface{} {
...
func (this *Scheme) Initialize(curdb Database) {
	this.InitializeXdoc(this.GetName(), this.GetFields(), curdb)
}

func (this *Scheme) Create(cUsername string, xDoc map[string]interface{}, curdb Database) string {
...
func (this *Scheme) Update(cUsername string, xDoc map[string]interface{}, curdb Database) string {
	xDoc["updatedby"] = cUsername
	xDoc["updatedate"] = this.GetSystemTime()
	return this.WriteXdoc(cUsername, this.GetName(), this.GetFields(), xDoc, curdb)
}

func (this *Scheme) Read(xDocrequest map[string]interface{}, curdb Database) (mapRes map[string]interface{}) {
...
func (this *Scheme) Search(xDocrequest map[string]interface{}, curdb Database) (mapRes map[string]interface{}) {
	...
	if xDocrequest["code"] != nil && xDocrequest["code"].(string) != "" {
		wherecode = fmt.Sprintf(`code = '%s' AND`, xDocrequest["code"])
	}
	...
	sql := `select 	code as code, control as control, title as title, 
			...
			where %s %s %s control != '' order by title limit %s offset %s`

	sql = fmt.Sprintf(sql, wherecode, whereworkflow, wheretitle, limit, offset)
	mapRes, _ = curdb.Query(sql)
	return mapRes
}

func (this *Scheme) Delete(xDocrequest map[string]interface{}, curdb Database) {
